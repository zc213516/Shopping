...
public class GridLayoutAdapter extends DelegateAdapter.Adapter {
    private ArrayList<ShopBean.DataDTO.NewGoodsListDTO> list;
    private Context context;
    private GridLayoutHelper gridLayoutHelper;

    public GridLayoutAdapter(ArrayList<ShopBean.DataDTO.NewGoodsListDTO> list, Context context, GridLayoutHelper gridLayoutHelper) {
        this.list = list;
