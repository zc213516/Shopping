...
public class SingleThreeAdapter extends DelegateAdapter.Adapter {
    private ArrayList<ShopBean.DataDTO.ChannelDTO>list;
    private Context context;
   private GridLayoutHelper gridLayoutHelper;

    public SingleThreeAdapter(ArrayList<ShopBean.DataDTO.ChannelDTO> list, Context context, GridLayoutHelper gridLayoutHelper) {
        this.list = list;
