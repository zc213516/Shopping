...
public class SingleTwoAdapter extends DelegateAdapter.Adapter {
    private ArrayList<ShopBean.DataDTO.BannerDTO>imgs;
    private SingleLayoutHelper singleLayoutHelper;

    public SingleTwoAdapter(ArrayList<ShopBean.DataDTO.BannerDTO> imgs, SingleLayoutHelper singleLayoutHelper) {
        this.imgs = imgs;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            bannerViewHolder.img.setImageLoader(new ImageLoader() {
                ...
                public void displayImage(Context context, Object path, ImageView imageView) {
                    ShopBean.DataDTO.BannerDTO db= (ShopBean.DataDTO.BannerDTO) path;
