...
public class GridLayoutSixAdapter extends DelegateAdapter.Adapter {
    private ArrayList<ShopBean.DataDTO.HotGoodsListDTO>list;
    private Context context;
    private GridLayoutHelper gridLayoutHelper;

    public GridLayoutSixAdapter(ArrayList<ShopBean.DataDTO.HotGoodsListDTO> list, Context context, GridLayoutHelper gridLayoutHelper) {
        this.list = list;
